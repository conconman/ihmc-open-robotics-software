...
mainDependencies {
   ...
   api("us.ihmc:mecano-graphviz:17-0.13.0-alpha3")
   ...
   api("us.ihmc:scs2-bullet-simulation:17-0.15.0-alpha1")
   api("us.ihmc:scs2-session-visualizer-jfx:17-0.15.0-alpha1")
