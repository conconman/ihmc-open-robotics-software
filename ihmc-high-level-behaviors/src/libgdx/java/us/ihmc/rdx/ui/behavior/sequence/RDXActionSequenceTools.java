...
public class RDXActionSequenceTools
{
   ...
   {
      return createBlankAction(actionDefinitionType.getSimpleName(), editor, robotModel, syncedRobot, selectionCollisionModel, baseUI, panel3D, ros2);
   }
                                                     ...
                                                     ROS2ControllerPublishSubscribeAPI ros2)
   {
      ...
      {
         return new RDXChestOrientationAction(editor, panel3D, robotModel, syncedRobot, selectionCollisionModel, ros2);
      }
      ...
      {
         return robotHasArms ? new RDXHandPoseAction(editor, panel3D, robotModel, syncedRobot, selectionCollisionModel, ros2) : null;
      }
      ...
      {
         return new RDXPelvisHeightPitchAction(editor, panel3D, robotModel, syncedRobot, selectionCollisionModel, ros2);
      }
