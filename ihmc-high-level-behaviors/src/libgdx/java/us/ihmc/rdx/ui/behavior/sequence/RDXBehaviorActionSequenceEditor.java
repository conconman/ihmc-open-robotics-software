   ...
   public void update()
   {
      if (actionToCreate.poll())
      {
         ...
         if (newAction instanceof RDXWalkAction walkAction)
         {
            ...
            walkAction.getState().getGoalFrame().update(findConvenientParentFrameName(walkAction, null), syncedRobot.getReferenceFrames()
         ...
         else if (newAction instanceof RDXChestOrientationAction chestOrientationAction)
         {
            ...
            if (nextPreviousChestOrientationAction != null)
            {
               ...
               chestOrientationAction.getState().getChestFrame().update(nextPreviousChestOrientationAction.getDefinition().getParentFrameName(), syncedRobot.getReferenceFrames()
                                                                                                                                                            .getCommonReferenceFrames());
            }
            else // set to current robot's chest pose
            {
               chestOrientationAction.getState().getChestFrame().setToReferenceFrameIncludingParent(syncedRobot.getReferenceFrames().getChestFrame(), syncedRobot.getReferenceFrames()
                                                                                                                                                                 .getCommonReferenceFrames());
         ...
         else if (newAction instanceof RDXPelvisHeightPitchAction pelvisHeightPitchAction)
         {
            ...
            if (nextPreviousPelvisHeightAction != null)
            {
               ...
               pelvisHeightPitchAction.getState().getPelvisFrame().update(nextPreviousPelvisHeightAction.getDefinition().getParentFrameName(), syncedRobot.getReferenceFrames()
                                                                                                                                                          .getCommonReferenceFrames());
            }
            else // set to current robot's pelvis pose
            {
               pelvisHeightPitchAction.getState().getPelvisFrame().setToReferenceFrameIncludingParent(syncedRobot.getReferenceFrames().getPelvisFrame(), syncedRobot.getReferenceFrames()
                                                                                                                                                                    .getCommonReferenceFrames());
