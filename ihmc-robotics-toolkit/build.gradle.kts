...
mainDependencies {
   ...
   api("us.ihmc:euclid-frame:0.20.0-alpha3")
   api("us.ihmc:euclid-frame-shape:0.20.0-alpha3")
   api("us.ihmc:euclid-shape:0.20.0-alpha3")
   api("us.ihmc:mecano:17-0.13.0-alpha3")
   api("us.ihmc:mecano-yovariables:17-0.13.0-alpha3")
   api("us.ihmc:ihmc-commons:0.32.0")
   api("us.ihmc:ihmc-messager-kryo:0.2.0")
   api("us.ihmc:ihmc-matrix-library:0.18.10")
   api("us.ihmc:ihmc-graphics-description:0.20.2")
   api("us.ihmc:simulation-construction-set-utilities:0.23.2")
   api("us.ihmc:ihmc-native-library-loader:2.0.2")
   api("us.ihmc:scs2-definition:17-0.15.0-alpha1")
...
testDependencies {
   ...
   api("us.ihmc:euclid-test:0.20.0-alpha3")
   api("us.ihmc:simulation-construction-set:0.23.2")
   api("us.ihmc:ihmc-matrix-library-test:0.18.10")
